...
# ===== 4. 메인 실행 =====
def rawdata(startmonth,endmonth,startdate,enddate):
    # 1) 월별 청구 + 기간 메타
    # raw_billing = call_get_demand_cost_list("202601", "202601")
    raw_billing = call_get_demand_cost_list(startmonth, endmonth)
    ...
    usage_json = call_get_contract_usage_by_daily(startdate, enddate)
